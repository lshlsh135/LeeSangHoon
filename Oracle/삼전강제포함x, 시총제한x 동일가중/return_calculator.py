...
class return_calculator:
    ...
    def rolling_12month_return_3factor(self,i,j,z):
        ...
        title_20010228 = [self.factor_name, 'ir_20010228='+str(ir_20010228), 'winrate_20010228='+str(winrate_20010228)  ]
        ...
        self.factor_name = [self.factor_name, 'ir_20010228='+str(ir_20010228), 'ir_20080228='+str(ir_20080228), 'winrate_20080228='+str(winrate_20080228),'winrate_20010228='+str(winrate_20010228)]
